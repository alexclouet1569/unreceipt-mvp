 ...
 * actually uses the client. Production /app/login was failing to
 * prerender for that reason. Keep the same singleton, just defer the
 * createClient call until something reads from it.
 */
